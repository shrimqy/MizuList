...
<div class="container" in:fade={{ duration: 300 }}>
  <div class="analytics">
        ...
        <div class="sContainer">
          ...
          <div class="sList">
            <div class="listContainer">
              <div class="listItem">
                <span class="material-icons" style="color:#2DB039;">
                  circle
                </span>
                <a href="/profile/{username}/list">Reading</a>
              </div>

              <div class="listData">{stats[1].UserBook.length}</div>
            </div>

            <div class="listContainer">
              <div class="listItem">
                <span class="material-icons" style="color:#C3C3C3">
                  circle
                </span>
                <a href="/profile/{username}/list/Planning">Plan to Read</a>
              </div>

              <div class="listData">{stats[2].UserBook.length}</div>
            </div>

            <div class="listContainer">
              <div class="listItem">
                <span class="material-icons" style="color:#F9D457">
                  circle
                </span>
                <a href="/profile/{username}/list/Paused">Paused</a>
              </div>

              <div class="listData">{stats[3].UserBook.length}</div>
            </div>

            <div class="listContainer">
              <div class="listItem">
                <span class="material-icons" style="color:#A12F31">
                  circle
                </span>
                <a href="/profile/{username}/list/Dropped">Dropped</a>
              </div>

              <div class="listData">{stats[4].UserBook.length}</div>
            </div>

            <div class="listContainer">
              <div class="listItem">
                <span class="material-icons" style="color:#26448F">
                  circle
                </span>
                <a href="/profile/{username}/list/Completed">Completed</a>
              </div>

              <div class="listData">{stats[5].UserBook.length}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="activity">
      ...
      <div class="aContainer">
        {#each uniqueLastActivity.slice(0, 5) as activity}
          <div class="bookCard">
            <div class="titleCover">
              {#if activity.book.coverUrl}
                <!-- Book cover source -->
                <div class="imageContainer">
                  <img
                    src={activity.book.coverUrl}
                    alt={activity.book.englishTitle}
                  />
                  <a
              ...
              <div class="titleProgress">
                <a href="/books/{activity.bookID}">
                  <div class="title">{activity.book.englishTitle}</div>
                </a>
                <div class="progress">
                  <div>{activity.category.name}</div>
                  <div>
                    {activity.pages ? activity.pages : "-"}/{activity.tPages
                      ? activity.tPages
                      : "?"}
                  </div>
                  <div>
  ...
  {#if fav.length > 0}
    <div class="favorites">
      <h1>Favorites</h1>
      <div class="bFav">
        {#each fav as favourite}
          <div class="favbookCard">
            <div class="favCover">
              {#if favourite.book.coverUrl}
                <a data-sveltekit-preload-data href="/books/{favourite.bookID}">
                  <img
                    src={favourite.book.coverUrl}
                    alt={favourite.book.englishTitle}
                  />
                </a>
              {:else}
                <span>No cover available</span>
