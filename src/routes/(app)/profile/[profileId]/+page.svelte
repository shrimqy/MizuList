						...
						<div class="titleCover">
							{#if activity.book.coverUrl}
								...
								<div class="imageContainer">
									...
									/>
									<a data-sveltekit-preload-data href="/books/{activity.bookID}">
							...
							<div class="titleProgress">
								...
								<div class="progress">
									...
									<div>{activity.pages ? activity.pages : '-'}/{activity.tPages ? activity.tPages : '?'}</div>
									<div>
										Scored
										<span>{activity.rating !== null && activity.rating !== '0' ? activity.rating : '-'}</span>
									</div>
								</div>
							</div>
						</div>
