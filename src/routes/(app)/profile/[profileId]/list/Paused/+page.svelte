<script>
  ...
  const convertedItems = filteredItems.map((item) => {
    const convertedCreatedAt = item.startedDate
      ? new Date(item?.startedDate)?.toISOString().split("T")[0]
      : null;
    const convertedUpdatedAt = item.lastUpdated
        ...
        <form>
          <div class="bookCard" in:slide={{ x: 0, y: 100, duration: 500 }}>
              ...
              {#if listItem.book.coverUrl}
                ...
                <div class="imageContainer">
                  ...
                  <button
                    ...
                    on:click|preventDefault={() => toggleForm(index)}
                    >open_in_new</button
                  >
                </div>
            ...
            <div class="contentWrapper">
              <div class="score">
                {listItem.rating !== "0" && null ? listItem.rating : "-"}
              </div>
              <div class="progress">
                    ...
                    <div class="editor-header">
                      <div class="bookdd">
                        ...
                        <div class="editor-title">
                          {listItem.book.englishTitle}
                        </div>
                        <input
                          type="hidden"
                          value={listItem.book.id}
                          name="bookId"
                        />
                      </div>
                    ...
                    <div class="e-userStatus">
                      <div class="e-1">
                        <select
                          id="status"
                          name="status"
                          bind:value={listItem.bookCategory[1]}
                        >
