        ...
        <div class="card">
            ...
            <div class="votes">
              {#if recommendation.Like?.User?.some((user) => user?.id === $page.data?.user?.id)}
                <button formaction="?/like">
                  <span class="material-icons" style="color:#ff4500;">
                    arrow_upward
                  </span>
                </button>
              {:else}
              ...
              {#if recommendation.Like?.User && recommendation.DisLike?.User}
                <div class="voteCount">
                  {recommendation.Like?.User?.length -
                    recommendation.DisLike?.User?.length ==
                  0
                    ? ""
                    : recommendation.Like?.User?.length -
                      recommendation.DisLike?.User?.length}
          ...
          <div class="titleCover">
            ...
            <div class="imageContainer">
              <img
                src={recommendation.book1.coverUrl}
                alt={recommendation.book1.englishTitle}
              />
            </div>
          ...
          <div class="titleCover">
            ...
            <div class="imageContainer">
              <img
                src={recommendation.book2.coverUrl}
                alt={recommendation.book2.englishTitle}
              />
            </div>
